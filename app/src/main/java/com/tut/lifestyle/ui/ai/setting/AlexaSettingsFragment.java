...
public class AlexaSettingsFragment extends Fragment implements RemoteRepresentationListener {
    public static final String TAG = "AlexaSettingsFragment";
    public static final String TITLE = "Alexa Setting";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_alexa, container, false);
    }
