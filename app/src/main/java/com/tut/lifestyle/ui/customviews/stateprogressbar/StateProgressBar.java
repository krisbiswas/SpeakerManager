...
//        mCheckFont = FontManager.getTypeface(context);
    ...
    private void initializePainters() {
        ...
        mStateCheckedForegroundPaint = setPaintAttributes(mStateNumberTextSize, mStateNumberForegroundColor);
...
/*
    ...
    public void setOnStateItemClickListener(OnStateChangeListener onStateItemClickListener) {
        mOnStateChangeListener = onStateItemClickListener;
    }
    ...
    private void initStateProgressBar(Context context) {
        ...
        mBackgroundColor = context.getColor(R.color.background_color);
        mForegroundColor = context.getColor(R.color.foreground_color);
        mStateNumberBackgroundColor = context.getColor(R.color.background_text_color);
        mStateNumberForegroundColor = context.getColor(R.color.foreground_text_color);
        mCurrentStateDescriptionColor = context.getColor(R.color.foreground_color);
        mStateDescriptionColor = context.getColor(R.color.background_text_color);
    ...
    public boolean performClick() {
        ...
        if (mOnStateChangeListener != null) {
            ...
            mOnStateChangeListener.onStateChange(this, getStateItem(mStateItemClickedNumber), mStateItemClickedNumber, getCurrentStateNumber() == mStateItemClickedNumber);
